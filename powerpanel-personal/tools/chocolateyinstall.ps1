...
$url        = 'https://dl4jz3rbrsfum.cloudfront.net/software/ppp_windows_2_2_0.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'CyberPower PowerPanel Personal*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  # MSI
  #silentArgs    = "-q" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
